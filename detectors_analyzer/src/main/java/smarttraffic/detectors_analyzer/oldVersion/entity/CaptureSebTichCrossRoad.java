...
@Entity
@Table(name = "capture_seb_tich_crossroad")
public class CaptureSebTichCrossRoad extends Capture{
    @Id
    ...
    public CaptureSebTichCrossRoad() {
    }
    ...
    public boolean equals(Object o) {
        ...
        CaptureSebTichCrossRoad captureGIcrossRoad = (CaptureSebTichCrossRoad) o;
